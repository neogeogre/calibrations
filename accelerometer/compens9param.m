function param = compens9param(obs, init)
% compens9param does a leat mean square for computing kx, ky, kz, bx, bxy,
...
function [a1, a2, a3, a4, a5, a6, a7, a8, a9, e1] = ...
    ModelFontionnel(kx, bx, ky, by, bxy, kz, bz, bxz, byz, obs)
...
fy   = obs(2);
fz   = obs(3);
h    = 0.000001; % Infinitesimal value
graw = computeg(kx, bx, ky, by, bxy, kz, bz, bxz, byz, fx, fy, fz);

a1 = (computeg(kx+h, bx, ky, by, bxy, kz, bz, bxz, byz, fx, fy, fz) - graw) / h;
a2 = (computeg(kx, bx+h, ky, by, bxy, kz, bz, bxz, byz, fx, fy, fz) - graw) / h;
a3 = (computeg(kx, bx, ky+h, by, bxy, kz, bz, bxz, byz, fx, fy, fz) - graw) / h;
a4 = (computeg(kx, bx, ky, by+h, bxy, kz, bz, bxz, byz, fx, fy, fz) - graw) / h;
a5 = (computeg(kx, bx, ky, by, bxy+h, kz, bz, bxz, byz, fx, fy, fz) - graw) / h;
a6 = (computeg(kx, bx, ky, by, bxy, kz+h, bz, bxz, byz, fx, fy, fz) - graw) / h;
a7 = (computeg(kx, bx, ky, by, bxy, kz, bz+h, bxz, byz, fx, fy, fz) - graw) / h;
a8 = (computeg(kx, bx, ky, by, bxy, kz, bz, bxz+h, byz, fx, fy, fz) - graw) / h;
a9 = (computeg(kx, bx, ky, by, bxy, kz, bz, bxz, byz+h, fx, fy, fz) - graw) / h;

% Calculs de l'ecart apparent e1
gv = 9.8055; % Jan Skalouds gravity according to Lab 6 of Senor Orientation
e1 = gv - graw;
